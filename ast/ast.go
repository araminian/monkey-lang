...
// ExpressionStatement is a node for an expression statement
...
// PrefixExpression is a node for a prefix expression
...
// InfixExpression is a node for an infix expression
...
// Boolean is a node for a boolean literal expression
type Boolean struct {
	Token token.Token
	Value bool
}
...
// IfExpression is a node for an if expression
...
// BlockStatement is a node for a block statement
...
// FunctionLiteral is a node for a function literal expression
